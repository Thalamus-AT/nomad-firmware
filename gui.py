...
class gui:
    ...
    def run_gui(self):
        ...
        left_frame = tk.Frame(master=self.window, width=self.width/2, height=self.height)
        right_frame = tk.Frame(master=self.window, width=self.width/2, height=self.height)
        ...
        input_frame = tk.Frame(master=left_frame, width=self.width/2, height=200)
        output_frame = tk.Frame(master=right_frame, width=self.width/2, height=200)
